...
public partial class AdminWindow : Window
{
    ...
    {
        AddAndEditProductWindow addAndEdit = new AddAndEditProductWindow(_user);
        addAndEdit.Show();
        Close();
    }

    private void ListProductsBox_SelectionChanged(object? sender, SelectionChangedEventArgs e)
    {
    }
}